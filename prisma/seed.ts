...
const TEAMS_2026 = [
  ...
  { name: 'Inglaterra', code: 'ENG', flagEmoji: '🏴󠁧󠁢󠁥󠁮󠁧󠁿', group: 'C', confederation: 'UEFA', tier: 1 },
  { name: 'Argentina', code: 'ARG', flagEmoji: '🇦🇷', group: 'D', confederation: 'CONMEBOL', tier: 1 },
  { name: 'España', code: 'ESP', flagEmoji: '🇪🇸', group: 'E', confederation: 'UEFA', tier: 1 },
  ...
  { name: 'Países Bajos', code: 'NED', flagEmoji: '🇳🇱', group: 'B', confederation: 'UEFA', tier: 2 },
  { name: 'Bélgica', code: 'BEL', flagEmoji: '🇧🇪', group: 'C', confederation: 'UEFA', tier: 2 },
  ...
  // Tier 3 - Competitive
  { name: 'México', code: 'MEX', flagEmoji: '🇲🇽', group: 'A', confederation: 'CONCACAF', tier: 3 },
  ...
  { name: 'Japón', code: 'JPN', flagEmoji: '🇯🇵', group: 'D', confederation: 'AFC', tier: 3 },
  ...
  // Tier 4 - Outsiders
  { name: 'Canadá', code: 'CAN', flagEmoji: '🇨🇦', group: 'C', confederation: 'CONCACAF', tier: 4 },
  ...
  { name: 'Arabia Saudí', code: 'KSA', flagEmoji: '🇸🇦', group: 'H', confederation: 'AFC', tier: 4 },
  { name: 'Nigeria', code: 'NGA', flagEmoji: '🇳🇬', group: 'A', confederation: 'CAF', tier: 4 },
  { name: 'Camerún', code: 'CMR', flagEmoji: '🇨🇲', group: 'B', confederation: 'CAF', tier: 4 },
]
